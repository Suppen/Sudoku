...
class SudokuBoard {
	 ...
	 * A string representing the sudoku board. Must have a length of 81 ({@link SudokuBoard.CELL_COUNT}). If not set, an empty board will be created
	 *
	 ...
	 *
	 * @property {Integer} row	Row number of the error
	 * @property {Integer} col	Column number of the error
	 * @property {Integer} square	Square number of the error
	 * @property {Integer} index	Board index of the cell in the row
	 * @property {Integer} value	Value of the cell in the row
	 *
	 ...
	 *
	 * @param {Integer} index	Index of the cell to get info for. An integer in the range 0 - {@link SudokuBoard.CELL_COUNT}-1
	 *
	 ...
	 *
	 * @param {Integer[]} indices	Array of the cell indices to get cells for. Indices are in the range 0 - {@link SudokuBoard.CELL_COUNT}-1
	 *
	...
	/**
	 * Sets the value of a cell. The cells are numbered:
	 * <pre>
	 * 0 1 2 ...
	 * 9 10 11 ...
	 * ...
	...
	/**
	 * All errors currently present on the board
	 *
	 * @type Cell[]
	 */
	get errors() {
	...
	/**
	 * A list of currently filled cells
	 *
	 * @type Cell[]
	 */
	get filledCells() {
	...
	/**
	 * Boolean telling whether or not the board is solved. True if it is, false otherwise
	 *
	 * @type Boolean
	 */
	get solved() {
		// The board is solved if all cells are filled and there are no errors
		return this.filledCells.length === SudokuBoard.CELL_COUNT && this.errors.length === 0;
	}
